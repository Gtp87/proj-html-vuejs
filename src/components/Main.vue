    ...
    <div class="container-70">
        <div class="row row-cols-3 mt-5">
            <div class="col news">
                ...
                <div class="news-text">
                    ...
                    <div class="news-date">October 11th, 2015 | 2 comments</div>
        ...
        <div class="featured-article">
            <div class="feat-article-text text-light">
                <h6 class="text-uppercase">featured article</h6>
            ...
            <div class="col-8">
                <div class="reviewed-product">
                    <div class="reviewed-product-text text-light">
                        <h6 class="text-uppercase">reviewed product</h6>
                        <h4>Mauris viverra atisan ipsus eget felis prims efficitur varius</h4>
                        <p>In quis lectus sed leo elementum faucibus in dapibus dictum. Nullamolestie tortor nec lectus veneratis, sed blandit dui, dolor at bibendum sadips ets ipsums dolore ficilis uns leo lectus.</p>
                        <button type="button" class="btn btn-dark">READ MORE ></button>
                    </div>
                </div>
